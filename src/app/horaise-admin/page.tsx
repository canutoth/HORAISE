...
export default function HoraiseAdminPage() {
  ...
  const handleLogin = async () => {
    // TEMPORÁRIO 
    // Ignora verificação de email/senha e vai direto para tela admin
    setLoading(true);
    setTimeout(() => {
        notifications.show({
            title: "Modo Dev",
            message: "Login ignorado. Redirecionando...",
            color: "blue",
            autoClose: 2000,
        });
        router.push("/horaise-admin/dashboard"); 
...
//   const [loading, setLoading] = useState(false);
  ...
  //   // Ignora verificação de email/senha e vai direto para o dashboard
  //   setLoading(true);
    
  //   // Simula um pequeno delay só para visual
  //   setTimeout(() => {
  //       notifications.show({
  //           title: "Modo Dev",
  //           message: "Login ignorado. Redirecionando...",
  ...
  //           autoClose: 2000,
  //       });
  //       router.push("/horaise-admin/dashboard"); // Redireciona para a página de administração
  //   }, 500);
  //   // ----------------------------------------------
  // };
